...
Pyrus 保持免费、本地优先。如果它让你的 Markdown 知识库更值得回访，欢迎通过[爱发电](https://afdian.com/a/insightcore)支持后续开发。

海外读者也可以通过 [GitHub Sponsors](https://github.com/sponsors/Insight4Core) 支持 Pyrus。
